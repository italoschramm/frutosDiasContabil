...
uses balancete, UFcts, login, previsao_fluxo, cadastra_previsao,
  ...
  data_module_facts, f_acessos, UComissoes, UComissoes_Oficina, f_processos;
...
begin
       if (f_login.usuario[11] = 11) or (f_login.usuario[10] = 10) then
      begin
...
begin
      ...
      if (f_login.usuario[6] = 6) or (f_login.usuario[10] = 10) then
      begin
...
begin
      if (f_login.usuario[12] = 12) or (f_login.usuario[10] = 10) then
      begin
...
begin
      if (f_login.usuario[8] = 8) or (f_login.usuario[10] = 10) then
      begin
...
begin
      ...
      if (f_login.usuario[5] = 5) or (f_login.usuario[10] = 10) then
      begin
...
begin
      if (f_login.usuario[3] = 3) or (f_login.usuario[10] = 10) then
      begin
...
procedure Tf_principal.Processos1Click(Sender: TObject);
begin
     if (f_login.usuario[13] = 13) or (f_login.usuario[10] = 10) then
      begin
       form_processos := tform_processos.create(self);
      end
      else
      showmessage('Acesso Negado!');
end;
...
begin
      ...
      if (f_login.usuario[7] = 7) or (f_login.usuario[10] = 10) then
      begin
...
begin
      ...
      if (f_login.usuario[4] = 4) or (f_login.usuario[10] = 10) then
      begin
...
begin
      if (f_login.usuario[9] = 9) or (f_login.usuario[10] = 10) then
      begin
