...
// (DO NOT EDIT: machine generated header) 'RpCon.pas' rev: 29.00 (Windows)
...
enum DECLSPEC_DENUM TRuntimeVisibility : unsigned char { rtNone, rtDeveloper, rtEndUser };
...
protected:
	System::Classes::TList* FConnectList;
...
public:
	...
	TRvCustomConnection* __fastcall FindConnection(System::UnicodeString ConnectName);
};

#pragma pack(pop)

class PASCALIMPLEMENTATION TDataConnectThread : public System::Classes::TThread
{
	typedef System::Classes::TThread inherited;
	
protected:
	System::Classes::TThreadMethod SyncMethod;
	bool SyncRan;
	TRvCustomConnection* FDataCon;
	void __fastcall SyncExecute(void);
	void __fastcall DoEvent(System::Classes::TThreadMethod AMethod);
	virtual void __fastcall Execute(void);
	
public:
	__property TRvCustomConnection* DataCon = {read=FDataCon, write=FDataCon};
public:
	/* TThread.Create */ inline __fastcall TDataConnectThread(void)/* overload */ : System::Classes::TThread() { }
	/* TThread.Create */ inline __fastcall TDataConnectThread(bool CreateSuspended)/* overload */ : System::Classes::TThread(CreateSuspended) { }
...
protected:
	...
	bool FIncluded;
	int FFieldIndex;
	System::UnicodeString StrData;
	void *BinData;
	int DataSize;
	
public:
	__fastcall TDataConnectFieldDef(Rpdefine::TRPDataType ADataType, System::UnicodeString AFieldName, bool AIncluded);
...
protected:
	...
	bool Runtime;
	System::UnicodeString ModeStr;
	bool ThreadDone;
	System::Classes::TList* FieldDefList;
	int FieldIdx;
	int IncludedFieldIdx;
	int FDataIndex;
	int FDataRows;
	System::UnicodeString FFilterFieldName;
	System::UnicodeString FFilterFieldOp;
	System::UnicodeString FFilterFieldData;
	bool FLocalFilter;
	bool LocalFilterValid;
	TRuntimeVisibility FRTVisible;
	System::Classes::TStrings* FFieldAliasList;
	...
	void __fastcall ReturnError(System::UnicodeString Msg, Rpdefine::TRaveConnectionError ErrorType);
	void __fastcall ReadVisible(System::Classes::TReader* Reader);
	virtual void __fastcall DefineProperties(System::Classes::TFiler* Filer);
	void __fastcall SetFieldAliasList(System::Classes::TStrings* Value);
	System::UnicodeString __fastcall GetFieldAlias(System::UnicodeString FieldName);
	void __fastcall NextField(void);
	
public:
	__fastcall virtual TRvCustomConnection(System::Classes::TComponent* AOwner);
	...
	void __fastcall WriteField(System::UnicodeString Name, Rpdefine::TRPDataType DataType, int Width, System::UnicodeString FullName, System::UnicodeString Description);
	...
	TDataConnectFieldDef* __fastcall FindFieldDef(System::UnicodeString FieldName);
	bool __fastcall ReadFilterItem(System::UnicodeString &FieldName, System::UnicodeString &FieldOp, System::UnicodeString &FieldData);
	...
	__property System::UnicodeString FilterFieldName = {read=FFilterFieldName};
	__property System::UnicodeString FilterFieldOp = {read=FFilterFieldOp};
	__property System::UnicodeString FilterFieldData = {read=FFilterFieldData};
	
__published:
	__property System::Classes::TStrings* FieldAliasList = {read=FFieldAliasList, write=SetFieldAliasList};
...
//-- var, const, procedure ---------------------------------------------------
extern DELPHI_PACKAGE int DataConVersion;
extern DELPHI_PACKAGE TDataConnectManager* DataConnectManager;
extern DELPHI_PACKAGE bool ManualSync;
extern DELPHI_PACKAGE void __fastcall ExecSyncMethod(void);
}	/* namespace Rpcon */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_RPCON)
