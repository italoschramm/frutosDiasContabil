...
begin
            ...
            begin
                  ...
                  and ((f_balancete.q_consulta2.FieldByName('CONTA_DEBITO').asstring = '3710010015') or
                        (f_balancete.q_consulta2.FieldByName('CONTA_CREDITO').asstring = '3710010015') or
                        (f_balancete.q_consulta2.FieldByName('CONTA_DEBITO').asstring = '3626950004'))
                  ...
                  // 18 --------------------------------------------------------
                   ...
                   if
                    (f_balancete.q_consulta2.FieldByName('COD_FABRICA').Asinteger <> 15) and
                   ((f_balancete.q_consulta2.FieldByName('CONTA_DEBITO').asstring = '3626950004') or
                   ...
                   then
                      ...
                      begin
                        ...
                        if (f_balancete.q_consulta2.FieldByName('CCUSTO_DEBITO').AsInteger = 1) or (f_balancete.q_consulta2.FieldByName('CCUSTO_DEBITO').AsInteger = 11) then
                        begin
                        valor[18,1] := valor[18,1] + f_balancete.q_consulta2.fieldbyname('VALOR').ASEXTENDED;
                        end;

                        if f_balancete.q_consulta2.FieldByName('CCUSTO_DEBITO').AsInteger = 9 then
                        begin
                        valor[18,2] := valor[18,2] + f_balancete.q_consulta2.fieldbyname('VALOR').ASEXTENDED;
                        end;

                        if f_balancete.q_consulta2.FieldByName('CCUSTO_DEBITO').AsInteger = 6 then
                        begin
                        valor[18,3] := valor[18,3] + f_balancete.q_consulta2.fieldbyname('VALOR').ASEXTENDED;
                        end;

                        if f_balancete.q_consulta2.FieldByName('CCUSTO_DEBITO').AsInteger = 2 then
                        begin
                        valor[18,4] := valor[18,4] + f_balancete.q_consulta2.fieldbyname('VALOR').ASEXTENDED;
                        end;

                        if f_balancete.q_consulta2.FieldByName('CCUSTO_DEBITO').AsInteger = 3 then
                        begin
                        valor[18,5] := valor[18,5] + f_balancete.q_consulta2.fieldbyname('VALOR').ASEXTENDED;
                        end;

                        if f_balancete.q_consulta2.FieldByName('CCUSTO_DEBITO').AsInteger = 5 then
                        begin
                        valor[18,6] := valor[18,6] + f_balancete.q_consulta2.fieldbyname('VALOR').ASEXTENDED;
                        end;

                        if f_balancete.q_consulta2.FieldByName('CCUSTO_DEBITO').AsInteger = 4 then
                        begin
                        valor[18,7] := valor[18,7] + f_balancete.q_consulta2.fieldbyname('VALOR').ASEXTENDED;
                        end;

                        if f_balancete.q_consulta2.FieldByName('CCUSTO_DEBITO').AsInteger = 10 then
                        begin
                        valor[18,8] := valor[18,8] + f_balancete.q_consulta2.fieldbyname('VALOR').ASEXTENDED;
                        end;

                        if f_balancete.q_consulta2.FieldByName('CCUSTO_DEBITO').AsInteger = 7 then
                        begin
                        valor[18,9] := valor[18,9] + f_balancete.q_consulta2.fieldbyname('VALOR').ASEXTENDED;
                        end;
