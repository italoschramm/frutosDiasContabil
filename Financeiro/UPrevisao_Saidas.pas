...
begin
      ...
      dm.q_realizado_media_saida_veiculos.params.ParamByName('data1').Value := mes_anterior3;
      dm.q_realizado_media_saida_veiculos.params.ParamByName('data2').Value := mes_anterior1;
      dm.q_realizado_media_saida_veiculos.params.ParamByName('cod_status1').Value := 1;
      dm.q_realizado_media_saida_veiculos.params.ParamByName('cod_status2').Value := 1;
      dm.q_realizado_media_saida_veiculos.params.ParamByName('cod_status3').Value := 1;
      ...
      dm.q_saida_veiculos.params.ParamByName('data1').Value := mes_inicio;
      dm.q_saida_veiculos.params.ParamByName('data2').Value := mes_fim;
      dm.q_saida_veiculos.params.ParamByName('cod_status1').Value := 0;
      dm.q_saida_veiculos.params.ParamByName('cod_status2').Value := 0;
      dm.q_saida_veiculos.params.ParamByName('cod_status3').Value := 0;
   ...
   //Vendas Veiculos ----------------------------------------------------------
    ...
    dm.q_historico_vendas.params.ParamByName('data1').Value := mes_anterior;
...
begin
      ...
      dm.q_saida_fornecedor_diversos.params.ParamByName('data1').Value := mes_inicio;
      dm.q_saida_fornecedor_diversos.params.ParamByName('data2').Value := mes_fim;
      dm.q_saida_fornecedor_diversos.params.ParamByName('cod_status1').Value := 0;
      dm.q_saida_fornecedor_diversos.params.ParamByName('cod_status2').Value := 0;
      dm.q_saida_fornecedor_diversos.params.ParamByName('cod_status3').Value := 0;
...
begin
      ...
      dm.q_realizado_media_saida_semi_novos.params.ParamByName('data1').Value := mes_anterior3;
      dm.q_realizado_media_saida_semi_novos.params.ParamByName('data2').Value := mes_anterior1;
      dm.q_realizado_media_saida_semi_novos.params.ParamByName('cod_status1').Value := 1;
      dm.q_realizado_media_saida_semi_novos.params.ParamByName('cod_status2').Value := 1;
      dm.q_realizado_media_saida_semi_novos.params.ParamByName('cod_status3').Value := 1;
      ...
      dm.q_saida_semi_novos.params.ParamByName('data1').Value := mes_inicio;
      dm.q_saida_semi_novos.params.ParamByName('data2').Value := mes_fim;
      dm.q_saida_semi_novos.params.ParamByName('cod_status1').Value := 0;
      dm.q_saida_semi_novos.params.ParamByName('cod_status2').Value := 0;
      dm.q_saida_semi_novos.params.ParamByName('cod_status3').Value := 0;
...
begin
      ...
      dm.q_saida_venda_direta.params.ParamByName('data1').Value := mes_inicio;
      dm.q_saida_venda_direta.params.ParamByName('data2').Value := mes_fim;
      dm.q_saida_venda_direta.params.ParamByName('cod_status1').Value := 0;
      dm.q_saida_venda_direta.params.ParamByName('cod_status2').Value := 0;
      dm.q_saida_venda_direta.params.ParamByName('cod_status3').Value := 0;
...
begin
      ...
      dm.q_saida_consorcio.params.ParamByName('data1').Value := mes_inicio;
      dm.q_saida_consorcio.params.ParamByName('data2').Value := mes_fim;
      dm.q_saida_consorcio.params.ParamByName('cod_status1').Value := 0;
      dm.q_saida_consorcio.params.ParamByName('cod_status2').Value := 0;
      dm.q_saida_consorcio.params.ParamByName('cod_status3').Value := 0;
      ...
      begin
                  ...
                  previsao_saida_dia[strtoint(dia),1] := previsao_saida_dia[strtoint(dia),1] + dm.q_saida_consorcio.FieldByName('VALOR').asfloat;
...
begin
      ...
      dm.q_historico_saida_luz.params.ParamByName('data1').Value := mes_anterior4;
      dm.q_historico_saida_luz.params.ParamByName('data2').Value := mes_anterior1;
      dm.q_historico_saida_luz.params.ParamByName('cod_status1').Value := 1;
      dm.q_historico_saida_luz.params.ParamByName('cod_status2').Value := 1;
      dm.q_historico_saida_luz.params.ParamByName('cod_status3').Value := 1;
      ...
      begin
            ...
            dm.q_saida_luz.params.ParamByName('data1').Value := mes_inicio;
            dm.q_saida_luz.params.ParamByName('data2').Value := mes_fim;
            dm.q_saida_luz.params.ParamByName('cod_cliente').Value := dm.q_historico_saida_luz.FieldByName('COD_CLIENTE').AsString;
            dm.q_saida_luz.params.ParamByName('cod_status1').Value := 0;
            dm.q_saida_luz.params.ParamByName('cod_status2').Value := 0;
            dm.q_saida_luz.params.ParamByName('cod_status3').Value := 0;
            dm.q_saida_luz.Open;
      ...
      begin
            ...
            dm.q_saida_luz2.params.ParamByName('data1').Value := mes_inicio;
            dm.q_saida_luz2.params.ParamByName('data2').Value := mes_fim;
            dm.q_saida_luz2.params.ParamByName('cod_status1').Value := 0;
            dm.q_saida_luz2.params.ParamByName('cod_status2').Value := 0;
            dm.q_saida_luz2.params.ParamByName('cod_status3').Value := 0;
...
begin
      ...
      dm.q_saida_diversos.params.ParamByName('data1').Value := mes_inicio;
      dm.q_saida_diversos.params.ParamByName('data2').Value := mes_fim;
      dm.q_saida_diversos.params.ParamByName('cod_status1').Value := 0;
      dm.q_saida_diversos.params.ParamByName('cod_status2').Value := 0;
      dm.q_saida_diversos.params.ParamByName('cod_status3').Value := 0;
...
begin
       ...
       dm.q_historico_saida_aluguel.params.ParamByName('data1').Value := mes_anterior4;
       dm.q_historico_saida_aluguel.params.ParamByName('data2').Value := mes_anterior1;
       dm.q_historico_saida_aluguel.params.ParamByName('cod_status1').Value := 1;
       dm.q_historico_saida_aluguel.params.ParamByName('cod_status2').Value := 1;
       dm.q_historico_saida_aluguel.params.ParamByName('cod_status3').Value := 1;
       ...
       begin
            ...
            dm.q_saida_aluguel.params.ParamByName('data1').Value := mes_inicio;
            dm.q_saida_aluguel.params.ParamByName('data2').Value := mes_fim;
            dm.q_saida_aluguel.params.ParamByName('cod_cliente').Value := dm.q_historico_saida_aluguel.FieldByName('COD_CLIENTE').AsString;
            dm.q_saida_aluguel.params.ParamByName('cod_status1').Value := 0;
            dm.q_saida_aluguel.params.ParamByName('cod_status2').Value := 0;
            dm.q_saida_aluguel.params.ParamByName('cod_status3').Value := 0;
...
begin
      ...
      dm.q_saida_impostos.params.ParamByName('data1').Value := mes_inicio;
      dm.q_saida_impostos.params.ParamByName('data2').Value := mes_fim;
      dm.q_saida_impostos.params.ParamByName('cod_status1').Value := 0;
      dm.q_saida_impostos.params.ParamByName('cod_status2').Value := 0;
      dm.q_saida_impostos.params.ParamByName('cod_status3').Value := 0;
...
begin
      ...
      dm.q_saida_transferencias.params.ParamByName('data1').Value := mes_anterior3;
      dm.q_saida_transferencias.params.ParamByName('data2').Value := mes_anterior1;
...
begin
      ...
      dm.q_saida_emprestimos.params.ParamByName('data1').Value := mes_inicio;
      dm.q_saida_emprestimos.params.ParamByName('data2').Value := mes_fim;
      dm.q_saida_emprestimos.params.ParamByName('cod_status1').Value := 0;
      dm.q_saida_emprestimos.params.ParamByName('cod_status2').Value := 0;
      dm.q_saida_emprestimos.params.ParamByName('cod_status3').Value := 0;
...
begin
      ...
      dm.q_saida_pecas.params.ParamByName('data1').Value := mes_inicio;
      dm.q_saida_pecas.params.ParamByName('data2').Value := mes_fim;
      dm.q_saida_pecas.params.ParamByName('cod_status1').Value := 0;
      dm.q_saida_pecas.params.ParamByName('cod_status2').Value := 0;
      dm.q_saida_pecas.params.ParamByName('cod_status3').Value := 0;
...
begin
       ...
       dm.q_historico_saida_salarios.params.ParamByName('data1').Value := mes_anterior4;
       dm.q_historico_saida_salarios.params.ParamByName('data2').Value := mes_anterior1;
       dm.q_historico_saida_salarios.params.ParamByName('cod_status1').Value := 1;
       dm.q_historico_saida_salarios.params.ParamByName('cod_status2').Value := 1;
       dm.q_historico_saida_salarios.params.ParamByName('cod_status3').Value := 1;
       ...
       begin
            ...
            dm.q_saida_salarios.params.ParamByName('data1').Value := mes_inicio;
            dm.q_saida_salarios.params.ParamByName('data2').Value := mes_fim;
            dm.q_saida_salarios.params.ParamByName('cod_cliente').Value := dm.q_historico_saida_salarios.FieldByName('COD_CLIENTE').AsString;
            dm.q_saida_salarios.params.ParamByName('cod_status1').Value := 0;
            dm.q_saida_salarios.params.ParamByName('cod_status2').Value := 0;
            dm.q_saida_salarios.params.ParamByName('cod_status3').Value := 0;
...
begin
      dm.q_saida_socios.Close;
      dm.q_saida_socios.params.ParamByName('data1').Value := mes_inicio;
      dm.q_saida_socios.params.ParamByName('data2').Value := mes_fim;
      dm.q_saida_socios.params.ParamByName('cod_status1').Value := 0;
      dm.q_saida_socios.params.ParamByName('cod_status2').Value := 0;
      dm.q_saida_socios.params.ParamByName('cod_status3').Value := 0;
      dm.q_saida_socios.Open;

      dm.q_saida_socios.first;

      while dm.q_saida_socios.Eof = false do
      begin

                  dia := copy(datetostr(dm.q_saida_socios.FieldByName('DATA_VENCIMENTO').Asdatetime),1,2);
                  previsao_saida_dia[strtoint(dia),16] := previsao_saida_dia[strtoint(dia),16] + dm.q_saida_socios.FieldByName('VALOR').asfloat;


           dm.q_saida_socios.Next;
      end;
...
begin
      ...
      dm.q_saida_rescisao.params.ParamByName('data1').Value := mes_inicio;
      dm.q_saida_rescisao.params.ParamByName('data2').Value := mes_fim;
      dm.q_saida_rescisao.params.ParamByName('cod_status1').Value := 0;
      dm.q_saida_rescisao.params.ParamByName('cod_status2').Value := 0;
      dm.q_saida_rescisao.params.ParamByName('cod_status3').Value := 0;
