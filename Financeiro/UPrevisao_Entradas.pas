...
begin
    ...
    dm.q_historico_vendas_veic.params.ParamByName('data1').Value := mes_anterior3;
    dm.q_historico_vendas_veic.params.ParamByName('data2').Value := mes_anterior1;
...
begin
      ...
      dm.q_vendas_cartoes.params.ParamByName('data1').Value := mes_inicio;
      dm.q_vendas_cartoes.params.ParamByName('data2').Value := mes_fim;
...
begin
      ...
      dm.q_entradas_transferencias.params.ParamByName('data1').Value := mes_anterior3;
      dm.q_entradas_transferencias.params.ParamByName('data2').Value := mes_anterior1;
