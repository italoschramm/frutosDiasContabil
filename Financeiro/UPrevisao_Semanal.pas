...
procedure previsao_semanal.saidas_pecas;
begin
      i := strtoint(formatdatetime('DD', now));
      j := 1;
       ...
       begin
            if i <= 31 then
            begin
                  previsao_semanal[13,j] := ObjPrevisao_Saidas.previsao_saida_dia[i,6];
                  i := i + 1;
            end;
            j := j + 1;
       end;
...
procedure previsao_semanal.saidas_salarios;
begin
      ...
      //Salarios e Encargos ----------------------
       ...
       begin
            if i <= 31 then
            begin
                  previsao_semanal[10,j] := previsao_semanal[10,j] + ObjPrevisao_Saidas.previsao_saida_dia[i,8];
                  i := i + 1;
            end;
            j := j + 1;
       end;
       ...
       begin
            if i <= 31 then
            begin
                  previsao_semanal[10,j] := previsao_semanal[10,j] + ObjPrevisao_Saidas.previsao_saida_dia[i,9];
                  i := i + 1;
            end;
            j := j + 1;
       end;
...
procedure previsao_semanal.saidas_emprestimos;
begin
      ...
      j := 1;
       ...
       begin
            if i <= 31 then
            begin
                  previsao_semanal[14,j] := ObjPrevisao_Saidas.previsao_saida_dia[i,19];
                  i := i + 1;
            end;
            j := j + 1;
       end;
