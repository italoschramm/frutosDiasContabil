...
begin
        ...
        planilha.cells[1,3] := 'Saídas - Previsão';
        ...
        planilha.cells[2,2] := 'Consórcio';
        planilha.cells[2,3] := 'Comissão';
        planilha.cells[2,4] := 'Veículos VN';
        planilha.cells[2,5] := 'Veículos VD';
        planilha.cells[2,6] := 'Semi-Novos';
        planilha.cells[2,7] := 'Peças GM';
        planilha.cells[2,8] := 'Cartão de Crédito';
        planilha.cells[2,9] := 'Sal. Encargos';
        planilha.cells[2,10] := 'Rescisão';
        planilha.cells[2,11] := 'Aluguel';
        planilha.cells[2,12] := 'Impsotos';
        planilha.cells[2,13] := 'Água/Luz/Internet/Dados';
        planilha.cells[2,14] := 'Emplacamento';
        planilha.cells[2,15] := 'Leasing/BNDES';
        planilha.cells[2,16] := 'Fornec. Diversos';
        planilha.cells[2,17] := 'Sócios';
        planilha.cells[2,18] := 'Diversos';
        planilha.cells[2,19] := 'Reforma 2014';
        planilha.cells[2,20] := 'Empréstimos';
