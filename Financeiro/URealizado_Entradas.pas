...
begin
    ...
    dm.q_vendas_veic.params.ParamByName('data1').Value := mes_inicio;
    dm.q_vendas_veic.params.ParamByName('data2').Value := mes_fim;
...
begin
      ...
      dm.q_cartoes.Close;
      dm.q_cartoes.params.ParamByName('data1').Value := mes_inicio;
      dm.q_cartoes.params.ParamByName('data2').Value := mes_fim;
      dm.q_cartoes.Open;
...
begin
    ...
    dm.q_vendas_dinheiro.params.ParamByName('data1').Value := mes_anterior3;
    dm.q_vendas_dinheiro.params.ParamByName('data2').Value := mes_anterior1;
...
begin
      ...
      dm.q_entradas_boleto.params.ParamByName('data1').Value := mes_inicio;
      dm.q_entradas_boleto.params.ParamByName('data2').Value := mes_fim;
...
begin
      ...
      dm.q_entradas_comissao.params.ParamByName('data1').Value := mes_inicio;
      dm.q_entradas_comissao.params.ParamByName('data2').Value := mes_fim;
...
begin
      ...
      dm.q_entradas_gm.params.ParamByName('data1').Value := mes_inicio;
      dm.q_entradas_gm.params.ParamByName('data2').Value := mes_fim;
...
begin
      ...
      dm.q_realizado_entradas_transferencias.params.ParamByName('data1').Value := mes_inicio;
      dm.q_realizado_entradas_transferencias.params.ParamByName('data2').Value := mes_fim;
...
begin
      ...
      dm.q_entradas_diaria_c.params.ParamByName('data1').Value := mes_inicio;
      dm.q_entradas_diaria_c.params.ParamByName('data2').Value := mes_fim;
