...
type
    ...
    public
    mes_ano : string;
    mes_anterior1, mes_anterior2, mes_anterior3, mes_anterior4, mes_inicio, mes_fim, mes_anterior, data_pesquisa2 : string;
    mes : Textfile;
...
begin
      ...
      begin
            ...
            mes_anterior4 := formatdatetime('01/MM/YYYY', IncMonth(strtodate(data_pesquisa2), -1));
      ...
      begin
            ...
            mes_anterior4 := formatdatetime('01/MM/YYYY', (IncMonth(now, -1)));
