...
begin
      ...
      begin
            ...
            msg.Subject := 'Audiência Agendada';
            msg.Body.Text := 'Data da Audiência: ' + dm_processos.cds_audiencias.FieldByName('DATA_AUDIENCIA').AsString + sLineBreak + sLineBreak +
                             'Hora da Audiência : ' + dm_processos.cds_audiencias.FieldByName('HORA_AUDIENCIA').AsString + sLineBreak +  sLineBreak;
