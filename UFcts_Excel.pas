...
begin
     ...
     //-------------------------------------------------------------------------
        ...
        planilha.cells[1,3] := 'Posição Financeira - Bancos';
        ...
        planilha.cells[2,8] := 'Itau - 16429-9(cartão)';
        planilha.cells[2,9] := 'Itau 31284-9(cartão)';
        planilha.cells[2,10] := 'Itau 33345-6(cartão)';
        planilha.cells[2,11] := 'Itau 31508-1(cobrança)';
...
begin
        ...
        planilha.cells[1,3] := 'RECEITAS E LUCRO - Veículos Usados';
        planilha.cells[1,3].Font.size := '15';
        planilha.cells[1,3].font.bold := true;
        planilha.cells[1,3].Interior.Color := clyellow;
        planilha.cells[1,3].VerticalAlignment := 3;
        ...
        planilha.cells[2,4] := 'Mês - Unid. Vend.';
        planilha.cells[2,5] := 'Mês - Vendas Liq.';
        planilha.cells[2,6] := 'Mês - Custo das Vendas';
        planilha.cells[2,7] := 'Mês - Lucro Bruto';
...
begin
      // Pagina 6
        ...
        planilha.cells[2,6] := 'Mês - Custo das Vendas';
        planilha.cells[2,7] := 'Mês - Lucro Bruto';
        planilha.cells[2,8] := 'Mês - P/Unid. Vend.';
